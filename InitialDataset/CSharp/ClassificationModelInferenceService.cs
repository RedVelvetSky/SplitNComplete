...
namespace TinyIDS.Services
{
    internal class ModelInferenceService
    {
        ...
        public ModelInferenceService(ITransformer trainedModel)
        {
            ...
            // creating a PredictionEngine from the trained model
        ...
        private void LoadModel()
        {
            ...
            try
            {
                // Load the trained model (not functioning)
        ...
        public void Predict(PacketData packetData)
        {
            try
            {
                ...
                string color = prediction.PredictedLabel ? "red" : "green"; // red is for malicious, green is for benign
